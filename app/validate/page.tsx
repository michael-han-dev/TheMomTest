              ...
              {step === 4 && (
                <div>
                  ...
                  <div className="p-6 mb-6 bg-primary-50 rounded-lg">
                    <h3 className="mb-4 text-xl font-semibold text-primary-700">Mom Test Interview Questions</h3>
                  ...
                  <div className="p-6 mb-6 bg-green-50 rounded-lg">
                    ...
                    <ol className="pl-5 space-y-2 list-decimal">
                      <li>Conduct at least 10 customer interviews using the questions above</li>
